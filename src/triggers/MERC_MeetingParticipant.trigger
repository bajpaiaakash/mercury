trigger MERC_MeetingParticipant on Meeting_Participant_MERC__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) {
    ...
    new GLBL_TriggerHandler()
        ...
        .bind(GLBL_TriggerHandler.Evt.afterinsert, new MERC_AllocatedCapCalculator(Meeting_Participant_MERC__c.SobjectType))
        .bind(GLBL_TriggerHandler.Evt.afterupdate, new MERC_AllocatedCapCalculator(Meeting_Participant_MERC__c.SobjectType))
        .bind(GLBL_TriggerHandler.Evt.afterdelete, new MERC_AllocatedCapCalculator(Meeting_Participant_MERC__c.SobjectType))
        .bind(GLBL_TriggerHandler.Evt.afterundelete, new MERC_AllocatedCapCalculator(Meeting_Participant_MERC__c.SobjectType))
        
        .bind(GLBL_TriggerHandler.Evt.afterinsert, new MERC_PaidCapCalculator(Meeting_Participant_MERC__c.SobjectType))
        .bind(GLBL_TriggerHandler.Evt.afterupdate, new MERC_PaidCapCalculator(Meeting_Participant_MERC__c.SobjectType))
        .bind(GLBL_TriggerHandler.Evt.afterdelete, new MERC_PaidCapCalculator(Meeting_Participant_MERC__c.SobjectType))
        .bind(GLBL_TriggerHandler.Evt.afterundelete, new MERC_PaidCapCalculator(Meeting_Participant_MERC__c.SobjectType))
