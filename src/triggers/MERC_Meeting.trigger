trigger MERC_Meeting on Meeting_MERC__c (before insert, before update, before delete, after insert, after update, after delete) {
    ...
    new GLBL_TriggerHandler()
        ...
        .bind(GLBL_TriggerHandler.Evt.afterupdate,  new MERC_AllocatedCapCalculator(Meeting_MERC__c.SobjectType))
        .bind(GLBL_TriggerHandler.Evt.afterupdate,  new MERC_PaidCapCalculator(Meeting_MERC__c.SobjectType))
