...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>MERC_Stamp_External_Id_Response</fullName>
        ...
        <name>MERC_Stamp External Id - Response</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>MERC_Set External Id - Response</fullName>
        <actions>
            <name>MERC_Stamp_External_Id_Response</name>
