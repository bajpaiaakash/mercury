...
&amp;&amp; ( (NOT(ISNEW()) &amp;&amp; NOT(CONTAINS(LastModifiedBy.Username,&apos;mercuryintegration.veeva@&apos;)) 
&amp;&amp; NOT(CONTAINS(LastModifiedBy.Username,&apos;gso1.informatica@&apos;)))  || (NOT(ISNEW())
&amp;&amp; (ISCHANGED(Academic_Qualifications_MERC__c) ||
