...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>MERC_Meeting_Active_Date</fullName>
        <description>Updated Meeting_Active_Date_MERC with date on which Meeting Status was updated to Active.</description>
        <field>Meeting_Active_Date_MERC__c</field>
...
Name</formula>
    ...
    <rules>
        ...
        <description>Date on which Meeting Status is updated to ACTIVE.  Captured for SLA Reporting : MERC : Created on 23/2/15 by Mike Cashman, Mavens Consulting</description>
