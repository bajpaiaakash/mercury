...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <formula>OR( (ISNEW()&amp;&amp; Maximum_Fee_MERC__c &lt;&gt; 0 &amp;&amp; !ISBLANK(Maximum_Fee_MERC__c) &amp;&amp; !ISBLANK(Minimum_Fee_MERC__c) &amp;&amp; ISPICKVAL(Confirm_Final_Fee_MERC__c,&apos;Pending Confirmation&apos;)  ) , ( !ISNEW() &amp;&amp; (ISBLANK(PRIORVALUE(Maximum_Fee_MERC__c)) || PRIORVALUE(Maximum_Fee_MERC__c) = 0)) &amp;&amp; (!ISBLANK(Maximum_Fee_MERC__c) &amp;&amp; Maximum_Fee_MERC__c &lt;&gt;0) &amp;&amp; (ISBLANK(PRIORVALUE(Minimum_Fee_MERC__c)) || PRIORVALUE(Minimum_Fee_MERC__c) = 0) &amp;&amp; !ISBLANK(Minimum_Fee_MERC__c) &amp;&amp; ISPICKVAL(Confirm_Final_Fee_MERC__c,&apos;Pending Confirmation&apos;) )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
</Workflow>
