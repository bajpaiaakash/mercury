...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>MICO_Planning_Poker_Sess_Content_Uniq</fullName>
    ...
    <rules>
        <fullName>MICO_Planning Poker Session Content Unique Id</fullName>
        <actions>
            <name>MICO_Planning_Poker_Sess_Content_Uniq</name>
