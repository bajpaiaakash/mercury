...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>External_ID_BudgetLine_MERC</fullName>
        ...
        <name>External ID-BudgetLine</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>MERC_External ID-BudgetLine</fullName>
        <actions>
            <name>External_ID_BudgetLine_MERC</name>
