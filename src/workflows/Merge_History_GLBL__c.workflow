...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>External_ID_MergeHistory_MERC</fullName>
        ...
        <name>External ID-MergeHistory</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>Mercury External ID-MergeHistory</fullName>
        <actions>
            <name>External_ID_MergeHistory_MERC</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
            <field>Merge_History_GLBL__c.Name</field>
